...
const PrivacyPolicy: NextPage<StaticPageProps<typeof getStaticProps>> = ({ contact, legal }) => {
            ...
            <MainLayout contact={contact.results[0].data} logo={logo_inverse} invertNavLinks>
                <div className="container max-w-4xl mx-auto w-full h-auto pt-20">
                    <div className="text-4xl">
                        <RichText render={legal.results[1].data.title} />
                    </div>
                    <div className="flex justify-start">
                        <a
                            href={legal.results[1].data.pdf.url}
                            download
                            target="_blank"
                    ...
                    <div className="leading-8">
                        <RichText render={legal.results[1].data.body} />
                    </div>
                </div>
            </MainLayout>
        </div>
