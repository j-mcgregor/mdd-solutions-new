...
export const Contact: NextPage<StaticPageProps<typeof getStaticProps>> = ({ vacancies, contact }): JSX.Element => {
    const { title, description } = vacancies.results[0].data
    ...
    return (
        <div>
            ...
            <MainLayout contact={contact.results[0].data} logo={logo}>
                <Header title={title} bgColor="bg-red-900" />
