...
const Nav: NextPage<NavbarProps> = ({ logo, transparent }) => {
                    ...
                    <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
                        <a
                            className={
                                ...
                                ' text-sm font-bold leading-relaxed inline-block mr-4 whitespace-no-wrap uppercase'
                            }
                            href="https://www.creative-tim.com/learning-lab/tailwind-starter-kit#/presentation"
                        >
                            <img className="w-32" src={logo?.url} alt={logo?.alt} />
                        </a>
                        <button
